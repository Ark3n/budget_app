...
IconData categoryIconFor({String? iconKey, String? categoryName}) {
  if (iconKey != null) {
...
/// Resolves icon from persisted category fields with graceful fallback.
...
/// Resolves a display color from stored category color keys.
